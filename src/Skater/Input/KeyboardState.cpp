...
#include "Skater/Input/KeyboardState.h"
...
namespace Skater {
    ...
    bool KeyboardState::GetKey(const Keys key) const {
    ...
    void KeyboardState::SetKey(const Keys key) {
        const auto keyVal = static_cast<int>(key);
    ...
    void KeyboardState::ClearKey(const Keys key) {
        const auto keyVal = static_cast<int>(key);
